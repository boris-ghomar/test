...
@section('title', __('auth_site.custom.ForgotPasswordForm.PageTile') . '-' . __('general.Email'))
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="auth-form-dark text-left py-5 px-sm-5">
                        ...
                        <div class="my-2 d-flex justify-content-start text-justify">
                            <h6 class="font-weight-light">@lang('auth_site.custom.ForgotPasswordForm.attempByEmail.notice')</h6>
                        </div>
                        <form class="pt-3" method="POST"
                            action="{{ SitePublicRoutesEnum::ForgotPasswordRecoveryAttemp->route() }}">
                            @csrf

                            <div class="form-group">

                                <label for="Email" class="d-flex">@lang('auth_site.custom.Email')</label>
                                <div class="input-group">
                                    ...
                                    <input class="ltr form-control form-control-lg border-0" id="Email"
                                        placeholder="@lang('auth_site.custom.placeholder_Email')" type="email" name="Email" required autofocus
                                        autocomplete="email"
