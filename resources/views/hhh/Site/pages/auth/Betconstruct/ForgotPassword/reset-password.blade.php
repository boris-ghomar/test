...
@section('title', __('auth_site.custom.ForgotPasswordForm.PageTile') . '-' .
    __('auth_site.custom.ForgotPasswordForm.ResetPassword'))
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="auth-form-dark text-left py-5 px-sm-5">
                        ...
                        <div class="my-2 d-flex">
                            <h4>@lang('auth_site.custom.ForgotPasswordForm.ResetPassword')</h4>
                        </div>
                        <div class="my-2 d-flex justify-content-start text-justify">
                            <h6 class="font-weight-light">@lang('auth_site.custom.ForgotPasswordForm.resetPassword.notice')</h6>
                        </div>
                        <form autocomplete="off" class="pt-3" method="POST"
                            action="{{ SitePublicRoutesEnum::ForgotPasswordResetPasswordAttemp->route() }}">
                            @csrf

                            <div class="form-group">
                                <label for="new_password" class="d-flex">@lang('passwords.newPassword')</label>
                                <div class="input-group">
                                    ...
                                    <input class="ltr form-control form-control-lg border-0" id="password"
                                        ...
                                        autocomplete="new-password" {{-- minlength="{{ config('hhh_config.validation.minLength.password') }}"
                                        maxlength="{{ config('hhh_config.validation.maxLength.password') }}" --}} value="{{ old('password') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="ltr form-control form-control-lg border-0" id="password_confirmation"
                                        ...
                                        required autocomplete="new-password" {{-- minlength="{{ config('hhh_config.validation.minLength.password') }}"
                            ...
                            {{-- <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="ltr form-control form-control-lg border-0 no-arrows" id="VerificationCode"
                                        placeholder="@lang('auth_site.custom.VerificationCode')" type="number" name="VerificationCode" required autofocus
