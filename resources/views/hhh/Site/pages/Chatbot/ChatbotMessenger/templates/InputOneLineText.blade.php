...
<div id="InputOneLineTextTemplate">

    <div class="form-group">
        <label for="MsgInput_TemplateViewID">InputTemplate_Label</label>

        <input id="MsgInput_TemplateViewID" type="text" class="form-control" style="min-width: 300px;"
...
<div id="InputOneLineTextPassedTemplate">

    <div class="form-group">
        <label for="MsgInput_TemplateViewID">InputTemplate_Label</label>

        <input id="MsgInput_TemplateViewID" type="text" class="form-control" style="min-width: 300px;"
            autocomplete="off" value="InputPassedTemplate_UserAnswer" disabled>
