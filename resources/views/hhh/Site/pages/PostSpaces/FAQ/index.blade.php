...
@section('extraPlugin_css')
    @include('hhh.Site.pages.PostSpaces.FAQ.plugin_css')
@endsection


@section('custom_css')
    @include('hhh.Site.pages.PostSpaces.FAQ.custom_css')
@endsection


@section('content')
    @include('hhh.Site.pages.PostSpaces.FAQ.content')
@endsection


@section('extraPlugin_js')
    @include('hhh.Site.pages.PostSpaces.FAQ.plugin_js')
@endsection


@section('custom_js')
    @include('hhh.Site.pages.PostSpaces.FAQ.custom_js')
@endsection
