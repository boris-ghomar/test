...
@section('extraPlugin_css')
    @include('hhh.BackOffice.pages.Posts.FaqPosts.Create.plugin_css')
@endsection


@section('custom_css')
    @include('hhh.BackOffice.pages.Posts.FaqPosts.Create.custom_css')
@endsection


@section('content')
    @include('hhh.BackOffice.pages.Posts.FaqPosts.Create.content')
@endsection


@section('extraPlugin_js')
    @include('hhh.BackOffice.pages.Posts.FaqPosts.Create.plugin_js')
@endsection


@section('custom_js')
    @include('hhh.BackOffice.pages.Posts.FaqPosts.Create.custom_js')
@endsection
