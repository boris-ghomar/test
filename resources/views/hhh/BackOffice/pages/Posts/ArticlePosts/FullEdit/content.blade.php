        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    {{-- MainPhoto-tab --}}
                    <li class="nav-item">
                        <a class="nav-link" id="main_photo-tab" data-bs-toggle="tab" href="#page-main_photo"
                            role="tab" aria-controls="page-main_photo" aria-selected="true"><i
                                class="fa-solid fa-image"></i>
                            @lang('PagesContent_PostForm.tab.MainPhoto.title')</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="page-content" role="tabpanel"
                        ...
                        @include('hhh.BackOffice.pages.Posts.ArticlePosts.FullEdit.TabsContent.Content')
                    </div>

                    {{-- MainPhoto --}}
                    <div class="tab-pane fade" id="page-main_photo" role="tabpanel" aria-labelledby="main_photo-tab">
                        @include('hhh.BackOffice.pages.Posts.ArticlePosts.FullEdit.TabsContent.MainPhoto')
                    </div>

                    {{-- SEO --}}
                    <div class="tab-pane fade" id="page-seo" role="tabpanel" aria-labelledby="seo-tab">
                        @include('hhh.BackOffice.pages.Posts.ArticlePosts.FullEdit.TabsContent.SEO')
                    </div>
