...
class ClientPermissionCategoryPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Clients_CategoriesPermissions->value;
    }
     ...
     */
    public function view(User $user, ClientPermissionCategory $clientPermissionCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ClientPermissionCategory $clientPermissionCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ClientPermissionCategory $clientPermissionCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ClientPermissionCategory $clientPermissionCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ClientPermissionCategory $clientPermissionCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
