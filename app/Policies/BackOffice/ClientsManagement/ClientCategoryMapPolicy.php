...
class ClientCategoryMapPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Clients_CategoriesMaps->value;
    }
     ...
     */
    public function view(User $user, ClientCategoryMap $clientCategoryMap = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ClientCategoryMap $clientCategoryMap = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ClientCategoryMap $clientCategoryMap = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ClientCategoryMap $clientCategoryMap = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ClientCategoryMap $clientCategoryMap = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
