...
class ClientTrustScorePolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Clients_TrustScores->value;
    }
     ...
     */
    public function view(User $user, ClientTrustScore $clientTrustScore = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ClientTrustScore $clientTrustScore = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ClientTrustScore $clientTrustScore = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ClientTrustScore $clientTrustScore = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ClientTrustScore $clientTrustScore = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, ClientTrustScore $clientTrustScore = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
