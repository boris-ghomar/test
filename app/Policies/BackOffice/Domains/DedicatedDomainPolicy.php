...
class DedicatedDomainPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_DedicatedDomains->value;
    }
     ...
     */
    public function view(User $user, DedicatedDomain $dedicatedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DedicatedDomain $dedicatedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DedicatedDomain $dedicatedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DedicatedDomain $dedicatedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DedicatedDomain $dedicatedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, DedicatedDomain $dedicatedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
