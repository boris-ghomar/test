...
class DomainExtensionPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_Extensions->value;
    }
     ...
     */
    public function view(User $user, DomainExtension $domainExtension = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DomainExtension $domainExtension = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DomainExtension $domainExtension = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DomainExtension $domainExtension = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DomainExtension $domainExtension = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
