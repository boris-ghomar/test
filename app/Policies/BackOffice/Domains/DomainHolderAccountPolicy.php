...
class DomainHolderAccountPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_HolderAccounts->value;
    }
     ...
     */
    public function view(User $user, DomainHolderAccount $domainHolderAccount = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DomainHolderAccount $domainHolderAccount = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DomainHolderAccount $domainHolderAccount = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DomainHolderAccount $domainHolderAccount = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DomainHolderAccount $domainHolderAccount = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, DomainHolderAccount $domainHolderAccount = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
