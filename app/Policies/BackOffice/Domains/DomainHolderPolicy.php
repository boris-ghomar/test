...
class DomainHolderPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_Holders->value;
    }
     ...
     */
    public function view(User $user, DomainHolder $domainHolder = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DomainHolder $domainHolder = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DomainHolder $domainHolder = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DomainHolder $domainHolder = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DomainHolder $domainHolder = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
