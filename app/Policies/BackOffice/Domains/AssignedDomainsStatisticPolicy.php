...
class AssignedDomainsStatisticPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_AssignedDomainsStatistics->value;
    }
     ...
     */
    public function view(User $user, AssignedDomainsStatistic $assignedDomainsStatistic = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, AssignedDomainsStatistic $assignedDomainsStatistic = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, AssignedDomainsStatistic $assignedDomainsStatistic = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, AssignedDomainsStatistic $assignedDomainsStatistic = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, AssignedDomainsStatistic $assignedDomainsStatistic = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, AssignedDomainsStatistic $assignedDomainsStatistic = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
