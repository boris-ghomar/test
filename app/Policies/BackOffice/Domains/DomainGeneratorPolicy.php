...
class DomainGeneratorPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_DomainGenerator->value;
    }
     ...
     */
    public function view(User $user, DomainImport $domainImport = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DomainImport $domainImport = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DomainImport $domainImport = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DomainImport $domainImport = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DomainImport $domainImport = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, DomainImport $domainImport = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
