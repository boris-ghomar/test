...
class AssignedDomainPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_AssignedDomains->value;
    }
     ...
     */
    public function view(User $user, AssignedDomain $assignedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, AssignedDomain $assignedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, AssignedDomain $assignedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, AssignedDomain $assignedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, AssignedDomain $assignedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, AssignedDomain $assignedDomain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
