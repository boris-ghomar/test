...
class DomainPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_All->value;
    }
     ...
     */
    public function view(User $user, Domain $domain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, Domain $domain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, Domain $domain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, Domain $domain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, Domain $domain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, Domain $domain = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
