...
class DomainCategoryPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_Categories->value;
    }
     ...
     */
    public function view(User $user, DomainCategory $domainCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DomainCategory $domainCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DomainCategory $domainCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DomainCategory $domainCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DomainCategory $domainCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
