...
class DomainPreparingReviewPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Domains_DomainPreparingReview->value;
    }
     ...
     */
    public function view(User $user, DomainPreparingReview $domainPreparingReview = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DomainPreparingReview $domainPreparingReview = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DomainPreparingReview $domainPreparingReview = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DomainPreparingReview $domainPreparingReview = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DomainPreparingReview $domainPreparingReview = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, DomainPreparingReview $domainPreparingReview = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
