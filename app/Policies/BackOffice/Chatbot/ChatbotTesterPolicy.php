...
namespace App\Policies\BackOffice\Chatbot;
...
class ChatbotTesterPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Chatbots_Testers->value;
    }
     ...
     */
    public function view(User $user, ChatbotTester $chatbotTester = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ChatbotTester $chatbotTester = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ChatbotTester $chatbotTester = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ChatbotTester $chatbotTester = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ChatbotTester $chatbotTester = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
