...
class ChatbotPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Chatbots_Bots->value;
    }
     ...
     */
    public function view(User $user, Chatbot $chatbot = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, Chatbot $chatbot = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, Chatbot $chatbot = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, Chatbot $chatbot = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, Chatbot $chatbot = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
