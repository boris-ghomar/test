...
namespace App\Policies\BackOffice\Currencies;
...
class CurrencyRatePolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Currencies_CurrencyRates->value;
    }
     ...
     */
    public function view(User $user, CurrencyRate $currencyRate = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, CurrencyRate $currencyRate = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, CurrencyRate $currencyRate = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, CurrencyRate $currencyRate = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, CurrencyRate $currencyRate = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, CurrencyRate $currencyRate = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
