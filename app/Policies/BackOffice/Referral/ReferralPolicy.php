...
class ReferralPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Referral_ReferralsManagement->value;
    }
     ...
     */
    public function view(User $user, Referral $referral = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, Referral $referral = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, Referral $referral = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, Referral $referral = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, Referral $referral = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, Referral $referral = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
