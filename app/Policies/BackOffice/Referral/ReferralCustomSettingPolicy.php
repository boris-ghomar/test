...
namespace App\Policies\BackOffice\Referral;
...
class ReferralCustomSettingPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Referral_ClientCustomSettings->value;
    }
     ...
     */
    public function view(User $user, ReferralCustomSetting $referralCustomSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ReferralCustomSetting $referralCustomSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ReferralCustomSetting $referralCustomSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ReferralCustomSetting $referralCustomSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ReferralCustomSetting $referralCustomSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, ReferralCustomSetting $referralCustomSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
