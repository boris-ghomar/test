...
class ReferralRewardItemPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Referral_RewardItems->value;
    }
     ...
     */
    public function view(User $user, ReferralRewardItem $referralRewardItem = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ReferralRewardItem $referralRewardItem = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ReferralRewardItem $referralRewardItem = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ReferralRewardItem $referralRewardItem = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ReferralRewardItem $referralRewardItem = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, ReferralRewardItem $referralRewardItem = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
