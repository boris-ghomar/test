...
class ReferralRewardPackagePolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Referral_RewardPackages->value;
    }
     ...
     */
    public function view(User $user, ReferralRewardPackage $referralRewardPackage = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ReferralRewardPackage $referralRewardPackage = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ReferralRewardPackage $referralRewardPackage = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ReferralRewardPackage $referralRewardPackage = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ReferralRewardPackage $referralRewardPackage = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, ReferralRewardPackage $referralRewardPackage = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
