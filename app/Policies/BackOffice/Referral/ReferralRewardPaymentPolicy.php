...
class ReferralRewardPaymentPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Referral_RewardPayments->value;
    }
     ...
     */
    public function view(User $user, ReferralRewardPayment $referralRewardPayment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ReferralRewardPayment $referralRewardPayment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ReferralRewardPayment $referralRewardPayment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ReferralRewardPayment $referralRewardPayment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ReferralRewardPayment $referralRewardPayment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, ReferralRewardPayment $referralRewardPayment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
