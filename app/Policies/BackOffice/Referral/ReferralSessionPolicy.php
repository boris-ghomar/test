...
class ReferralSessionPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Referral_ReferralSessions->value;
    }
     ...
     */
    public function view(User $user, ReferralSession $referralSession = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ReferralSession $referralSession = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ReferralSession $referralSession = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ReferralSession $referralSession = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ReferralSession $referralSession = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function export(User $user, ReferralSession $referralSession = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
