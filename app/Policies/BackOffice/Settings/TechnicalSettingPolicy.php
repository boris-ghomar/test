...
class TechnicalSettingPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Settings_TechnicalSettings->value;
    }
     ...
     */
    public function view(User $user, TechnicalSetting $technicalSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, TechnicalSetting $technicalSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, TechnicalSetting $technicalSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, TechnicalSetting $technicalSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, TechnicalSetting $technicalSetting = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
