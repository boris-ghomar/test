...
class DynamicDataPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Settings_DynamicData->value;
    }
     ...
     */
    public function view(User $user, DynamicData $dynamicData = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, DynamicData $dynamicData = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, DynamicData $dynamicData = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, DynamicData $dynamicData = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, DynamicData $dynamicData = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
