...
class PersonnelPermissionRolePolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Personnel_RolesPermissions->value;
    }
     ...
     */
    public function view(User $user, PersonnelPermissionRole $personnelPermissionRole = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, PersonnelPermissionRole $personnelPermissionRole = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, PersonnelPermissionRole $personnelPermissionRole = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, PersonnelPermissionRole $personnelPermissionRole = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, PersonnelPermissionRole $personnelPermissionRole = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
