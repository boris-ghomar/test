...
class PersonnelPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Personnel_Management->value;
    }
     ...
     */
    public function view(User $user, Personnel $personnel = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, Personnel $personnel = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, Personnel $personnel = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, Personnel $personnel = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, Personnel $personnel = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
