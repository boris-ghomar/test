...
namespace App\Policies\BackOffice\Comments;
...
class UnapprovedCommentPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::UnapprovedComments_Management->value;
    }
     ...
     */
    public function view(User $user, UnapprovedComment $unapprovedComment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, UnapprovedComment $unapprovedComment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, UnapprovedComment $unapprovedComment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, UnapprovedComment $unapprovedComment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, UnapprovedComment $unapprovedComment = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
