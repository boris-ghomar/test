...
class FaqPostPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Posts_Faq->value;
    }
     ...
     */
    public function view(User $user, FaqPost $faqPost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, FaqPost $faqPost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, FaqPost $faqPost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, FaqPost $faqPost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, FaqPost $faqPost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
