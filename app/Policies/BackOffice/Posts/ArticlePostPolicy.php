...
class ArticlePostPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::Posts_Articles->value;
    }
     ...
     */
    public function view(User $user, ArticlePost $articlePost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, ArticlePost $articlePost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, ArticlePost $articlePost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, ArticlePost $articlePost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, ArticlePost $articlePost = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
