...
class PostCategoryPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::PostGrouping_Categories->value;
    }
     ...
     */
    public function view(User $user, PostCategory $postCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, PostCategory $postCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, PostCategory $postCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, PostCategory $postCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, PostCategory $postCategory = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
