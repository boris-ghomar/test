...
class PostSpacePolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::PostGrouping_Spaces->value;
    }
     ...
     */
    public function view(User $user, PostSpace $postSpace = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, PostSpace $postSpace = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, PostSpace $postSpace = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, PostSpace $postSpace = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, PostSpace $postSpace = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
