...
class PostSpacePermissionPolicy extends superPolicy
{
    /**
    ...
    {
        return AdminRoutesEnum::PostGrouping_PostSpacesPermissions->value;
    }
     ...
     */
    public function view(User $user, PostSpacePermission $postSpacePermission = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function update(User $user, PostSpacePermission $postSpacePermission = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function delete(User $user, PostSpacePermission $postSpacePermission = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function restore(User $user, PostSpacePermission $postSpacePermission = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
     ...
     */
    public function forceDelete(User $user, PostSpacePermission $postSpacePermission = null): bool
    {
        return $this->isPermissionValid($user, __FUNCTION__);
    }
}
