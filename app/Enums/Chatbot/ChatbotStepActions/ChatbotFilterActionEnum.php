...
enum ChatbotFilterActionEnum implements Translatable
{
    use EnumActions;
    ...
    {
        return match ($this) {
            self::Type => __('thisApp.AdminPages.Chatbot.Form.Filter.StepType'),
    ...
    public static function getModel(array|null $data = null): array
    {
        ...
        $defaultType = ChatbotFilterTypesEnum::ClientCategory;
        ...
        if (!is_null($data)) {
            ...
            /** @var ChatbotFilterTypesEnum $typeCase */
            $typeCase = isset($data[$typeKey]) ? ChatbotFilterTypesEnum::getCase($data[$typeKey]) : false;
     ...
     * @return \App\Models\BackOffice\Chatbot\ChatbotMessage|null|false
     */
    public static function makeChatMessage(?ChatbotStep $chatbotStep, ?ChatbotChat $chatbotChat): ChatbotMessage|false|null
    {
        $typeKey = self::Type->name;
        $dataKey = self::Data->name;
        ...
        try {
            ...
            if (!is_null($messageContent)) {
                ...
                $chatbotMessage = new ChatbotMessage([
                    ...
                    ChatbotMessagesTableEnum::Type->dbName()            => ChatbotMessageTypesEnum::Filter->name,
            ...
            /// MessageTemplate_MessageElement
