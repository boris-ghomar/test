...
enum ChatbotActionActionEnum implements Translatable
{
    use EnumActions;
    ...
    {
        return match ($this) {
            self::Type => __('thisApp.AdminPages.Chatbot.Form.BotAction.StepType'),
    ...
    public static function getModel(array|null $data = null): array
    {
        ...
        $defaultType = ChatbotActionTypesEnum::GoToStep;
        ...
        if (!is_null($data)) {
            ...
            /** @var ChatbotActionTypesEnum $typeCase */
            $typeCase = isset($data[$typeKey]) ? ChatbotActionTypesEnum::getCase($data[$typeKey]) : false;
        ...
        try {
            ...
            if (!is_null($messageContent)) {
                ...
                $chatbotMessage = new ChatbotMessage([
                    ...
                    ChatbotMessagesTableEnum::Type->dbName()            => ChatbotMessageTypesEnum::BotAction->name,
