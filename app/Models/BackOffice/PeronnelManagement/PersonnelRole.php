...
class PersonnelRole extends Role
{
    /**************** Parnet Items ********************/
    ...
    {
        static::addGlobalScope(ModelGlobalScopesEnum::PersonnelRole_Only->name, function (Builder $builder) {
            $builder->where(TableEnum::Type->dbName(), RoleTypesEnum::AdminPanel->name);
        });
    }
    /**************** Parnet Items END ********************/
    ...
    {
        return $this->hasMany(Personnel::class, UsersTableEnum::RoleId->dbName(), TableEnum::Id->dbName());
    }
