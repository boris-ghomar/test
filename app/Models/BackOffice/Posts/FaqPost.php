...
class FaqPost extends Post
{
    ...
    protected static function booted()
    {
        ...
        static::addGlobalScope(ModelGlobalScopesEnum::FaqPost_Only->name, function (Builder $builder) {

            $builder->whereIn(TableEnum::PostSpaceId->dbName(), PostSpace::Faqs()->PluckIds());
        });
    }
    /**************** Parnet Items END ********************/
    ...
    {
        return AdminPublicRoutesEnum::Posts_FaqEdit->url(['faqPost' => $this[TableEnum::Id->dbName()]]);
    }
    ...
    public function getDisplayUrlAttribute(): string
    {
        ...
        return $this[TableEnum::DisplayUrlFaq->dbName()];
    }
