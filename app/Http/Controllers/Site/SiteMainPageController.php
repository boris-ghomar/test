...
class SiteMainPageController extends Controller
{
    private $user;
    ...
    public function index(Request $request)
    {
        ...
        $paginator = $this->getPostsCollection();
        ...
        return view('hhh.Site.pages.MainPage.index', $data);
    }
    ...
    private function getAuthorizedGroupIds(): array
    {
        ...
        $activeSapces = PostSpace::Articles()
            ->has('publishedPosts')
            ->where($isActiveCol, 1)
