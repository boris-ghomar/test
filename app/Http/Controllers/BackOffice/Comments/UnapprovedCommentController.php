...
use App\Http\Requests\BackOffice\Comments\UnapprovedCommentRequest;
...
class UnapprovedCommentController extends SuperCommentController
{
    /**
    ...
    {
        $this->authorize(PermissionAbilityEnum::viewAny->name, UnapprovedComment::class);

        $jsGrid_Controller = parent::getJsGridType(UnapprovedComment::class, jsGrid_Controller::jsGridType_EditDelete);
        $jsGrid_Controller->setApiBaseUrl(url(config('hhh_config.apiBaseUrls.backoffice.javascript')));
        $jsGrid_Controller->setApiSubUrl("comments/unapproved_comments");
        ...
        return view('hhh.BackOffice.pages.Comments.UnapprovedCommentsManagement.index', $data);
    }
     ...
     *
     * @param  \App\Http\Requests\BackOffice\Comments\UnapprovedCommentRequest $request
     * @param  \App\Models\BackOffice\Comments\Comment $comment
     * @return \Illuminate\Http\JsonResponse JsonResponse
     */
    public function update(UnapprovedCommentRequest $request, Comment $comment): JsonResponse
    {
     ...
     * @return \Illuminate\Http\JsonResponse JsonResponse
     */
    public function destroy(UnapprovedCommentRequest $request): JsonResponse
    {
    ...
    public function apiIndex(Request $request)
    {
        ...
        return new CommentCollection(
            UnapprovedComment::ApiIndexCollection($request->input())
                ->paginate($pageSize)
        );
    }
}
