...
use App\Http\Requests\BackOffice\Tickets\OpenTicketRequest;
use App\Http\Resources\BackOffice\Tickets\OpenTicketResource;
use App\Http\Resources\BackOffice\Tickets\OpenTicketsCollection;
...
class OpenTicketController extends SuperJsGridController
{
    /**
    ...
    public function index()
    {
        ...
        $this->authorize(PermissionAbilityEnum::viewAny->name, OpenTicket::class);

        $jsGrid_Controller = parent::getJsGridType(OpenTicket::class, jsGrid_Controller::jsGridType_EditDelete);
        $jsGrid_Controller->setApiBaseUrl(url(config('hhh_config.apiBaseUrls.backoffice.javascript')));
        $jsGrid_Controller->setApiSubUrl("tickets/open_tickets");
        ...
        $attributes = (new OpenTicketRequest())->attributes();
        ...
        if ($user->can(PermissionAbilityEnum::update->name, OpenTicket::class)) {
        ...
        return view('hhh.BackOffice.pages.Tickets.OpenTickets.index', $data);
    }
     ...
     *
     * @param \App\Http\Requests\BackOffice\Tickets\OpenTicketRequest $request
     * @return \Illuminate\Http\JsonResponse JsonResponse
     */
    public function store(OpenTicketRequest $request)
    {
        //
    }
     ...
     */
    public function show(OpenTicket $ticket)
    {
        //
    }
     ...
     */
    public function edit(OpenTicket $ticket)
    {
        //
    }
     ...
     *
     * @param \App\Http\Requests\BackOffice\Tickets\OpenTicketRequest $request
     * @param \App\Models\BackOffice\Tickets\OpenTicket $ticket
     * @return \Illuminate\Http\JsonResponse JsonResponse
     */
    public function update(OpenTicketRequest $request, OpenTicket $ticket): JsonResponse
    {
        ...
        try {
            ...
            $item = OpenTicket::find($request->input(TableEnum::Id->dbName()));
        ...
        return JsonResponseHelper::successResponse(new OpenTicketResource($request->input()), null, HttpResponseStatusCode::Created->value);
    }
     ...
     * @return \Illuminate\Http\JsonResponse JsonResponse
     */
    public function destroy(OpenTicketRequest $request): JsonResponse
    {
        if ($item = OpenTicket::find($request->input(TableEnum::Id->dbName()))) {
     ...
     * @return void
     */
    private function destroyTicketMessages(OpenTicket $ticket): void
    {
        // Image messages
    ...
    public function apiIndex(Request $request)
    {
        ...
        return new OpenTicketsCollection(
            OpenTicket::ApiIndexCollection($request->input())
                ->paginate($pageSize)
        );
    }
}
