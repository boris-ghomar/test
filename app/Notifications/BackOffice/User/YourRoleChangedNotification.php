...
class YourRoleChangedNotification extends SuperDatabaseNotification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct(int $oldRoleId, int $newRoleId)
    {
    ...
    {
        return trans('notifications.YourRoleChanged.subject');
    }
    ...
    public static function getMessage(string $notificationId): ?string
    {
        try {
            if ($notification = Notification::find($notificationId)) {
                ...
                return trans(
                    'notifications.YourRoleChanged.message',
