...
class YourTicketWaitingYourResponseNotification extends SuperDatabaseNotification
{
    use Queueable;
    ...
    {
        return config('hhh_config.notification.categories.warning.iconBgClass');
    }
    ...
    {
        return trans('notifications.YourTicketWaitingYourResponse.subject');
    }
        ...
        try {
            if ($notification = Notification::find($notificationId)) {
                ...
                if ($ticket = Ticket::find($ticketId)) {
                    ...
                    $message = trans(
                        'notifications.YourTicketWaitingYourResponse.message',
                        [
                            'ticketId'        => $ticketId,
                        ]
                    );
