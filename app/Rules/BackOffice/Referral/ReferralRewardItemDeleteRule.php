...
class ReferralRewardItemDeleteRule implements ValidationRule
{
    ...
    {
        $referralRewardItem = ReferralRewardItem::find($value);
        ...
        if (!is_null($referralRewardPackage)) {
            ...
            if ($referralRewardPackage[$attribute] != $value) {
                ...
                if (!is_null($runningReferralSession))
                    $fail('thisApp.Errors.Referral.ReferralRewardItemDeleteRule.UsedInReferralSession')->translate(
                ...
                if ($isUsedInReferralPayment)
                    $fail('thisApp.Errors.Referral.ReferralRewardItemDeleteRule.UsedInRewardPayment')->translate(
                        $this->addPadToArrayVal([
                            'itemName' => $referralRewardItem[ReferralRewardItemsTableEnum::Name->dbName()],
                        ])
                    );
