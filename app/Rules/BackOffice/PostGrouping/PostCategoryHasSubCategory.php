...
class PostCategoryHasSubCategory implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if ($postCategory = PostCategory::select(TableEnum::Id->dbName(), TableEnum::Title->dbName())->find($value)) {
            ...
            if ($postCategory->subCategories()->exists())
                $fail('thisApp.Errors.PostGrouping.PostCategoryHasSubCategory')->translate(['name' => $name]);
        } else
