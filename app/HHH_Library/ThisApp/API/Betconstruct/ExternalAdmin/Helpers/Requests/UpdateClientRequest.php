...
class UpdateClientRequest extends SuperApiRequest
{
    ...
    */
     ...
     * @param array $data
     */
    function __construct(int|string $clientId, array $data)
    {
        $this->params = $data;
        $this->params[ClientModelEnum::Id->name] = $clientId;
    }
    ...
    public function send(): self
    {
        ...
        if (count($requiredParams) < 2) {
            ...
            $this->setResponse(JsonResponseHelper::errorResponse(
                null,
                'This request must have at least 1 data more than ID.',
    ...
    {
        $this->params = ClientModelEnum::convertDataToBcModel($this->params);
        return $this->params;
    }
