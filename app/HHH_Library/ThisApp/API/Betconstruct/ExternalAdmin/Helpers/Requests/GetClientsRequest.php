...
class GetClientsRequest extends SuperApiRequest
{
    ...
    /*
        ...
        $url= "http://agp-externaladmin.betconstruct.com/api/en/934/Client/GetClients";
    ...
    */
    ...
    {
        return FilterClientModelEnum::castParams($this->params);
    }
