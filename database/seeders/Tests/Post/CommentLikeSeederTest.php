...
use Database\Factories\Site\UserActions\CommentLikeFactory;
use Illuminate\Database\Eloquent\Factories\Sequence;
use Illuminate\Database\Seeder;

class CommentLikeSeederTest extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // php artisan db:seed --class=Database\Seeders\Tests\Post\CommentLikeSeederTest
    }
}
